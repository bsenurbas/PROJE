...
from .views import HomePageView, register, diets_page, training_page,  get_bmi_recommendation, recipe_detail, workout_detail, ipucu_page,yapayzeka
from . import views
...
urlpatterns = [
    ...
    path('yapayzeka/', yapayzeka, name='yapayzeka'),
]
